        ...
        <span key={i} className="inline-block mr-[0.2em] whitespace-nowrap">
          {word.split("").map((char, j) => (
            <motion.span
              ...
              style={{
                color: word.toLowerCase().includes("help")
                  ? "#078a52"
                  : "inherit",
              }}
            >
    ...
    >
      ...
      >
        <div className="absolute inset-y-0 left-5 flex items-center pointer-events-none">
          <Search
            className={`w-5 h-5 transition-colors ${isFocused ? "text-[#078a52]" : "text-[#9f9b93]"}`}
          />
        </div>
        <input
          type="text"
  ...
  return (
    ...
    >
      ...
      <div className="relative h-full bg-white border border-[#dad4c8] rounded-[32px] p-8 flex flex-col gap-8 overflow-hidden z-10">
        ...
        <div
          className="mt-auto flex items-center gap-3 text-xs font-black uppercase tracking-[0.12em] transition-all group-hover:gap-5"
...
const FAQItem = ({
  ...
  return (
    <motion.div layout className="border-b border-[#dad4c8]/50 last:border-0">
      ...
      >
        <span
          className={`text-lg font-semibold transition-all ${isOpen ? "text-[#078a52] translate-x-2" : "text-[#000000] group-hover:text-[#078a52] group-hover:translate-x-1"}`}
        >
          {question}
        </span>
        <motion.div
        ...
        >
          <ChevronRight
            className={`w-4 h-4 transition-colors ${isOpen ? "text-white" : "text-[#55534e]"}`}
          />
        </motion.div>
      </button>
  ...
  const categories = [
    {
      ...
      description:
        "New here? Master the fundamentals of cloud provisioning in minutes.",
      icon: Zap,
    ...
    },
    {
      ...
      description:
        "Manage your team's access levels and keep your data fortified.",
      icon: ShieldCheck,
    ...
    },
    {
      ...
      description:
        "Step-by-step guides on creating, tracking, and completing orders.",
      icon: BookOpen,
    ...
    },
    {
      title: "Admin Tools",
      description:
        "Powerful features for bulk operations and system configuration.",
      icon: Settings,
      accent: "ube" as const,
    },
  ];
    ...
    <div className="max-w-7xl mx-auto pb-32 px-6">
      ...
      <section className="relative pt-20 pb-20 text-center space-y-10 z-10">
        ...
        <p className="text-[#9f9b93] text-xl max-w-2xl mx-auto leading-relaxed">
          The ultimate resource for mastering the MC Dashboard. Find instant
          answers, technical docs, and direct support.
        </p>
          ...
          <div className="p-10 bg-black rounded-[40px] text-white space-y-8 relative overflow-hidden">
            ...
            <div className="space-y-2">
              ...
              <p className="text-white/50 text-sm leading-relaxed">
                Can't find what you're looking for? Our specialist team is ready
                to assist.
              </p>
            </div>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <button
                    key={action.label}
                    className="p-4 rounded-2xl bg-[#faf9f7] hover:bg-black hover:text-white transition-all group flex flex-col items-center gap-2"
                  >
                    <action.icon
